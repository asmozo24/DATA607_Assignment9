...
NyTimes_newsC <- content(NyTimes_newsRaw, as = 'text')  # getting content
#str(NyTimes_newsC)

NyTimes_newsJ <- fromJSON(NyTimes_newsC)

glimpse(NyTimes_newsJ) # THIS GIVES me an overview of all news in category 
...
cat("The most viewed article on The New York Times is :", NyTimes_newsJ2$results$url[1])
